...
**Current limitations:**
- This pipeline currently uses **hardcoded conda environment paths** in some configuration files
...
**Future improvements:**
- Docker/Singularity containerization for complete portability
- Automated environment creation without hardcoded paths
- Cloud execution profiles (AWS, Google Cloud, Azure)
- Integration with nf-core standards

## Citation

If you use this pipeline, please cite:

- **scIB framework**: Luecken, M.D., Büttner, M., Chaichoompu, K. et al. Benchmarking atlas-level data integration in single-cell genomics. *Nat Methods* **19**, 41–50 (2022). [https://doi.org/10.1038/s41592-021-01336-8](https://doi.org/10.1038/s41592-021-01336-8)

- **Nextflow**: Di Tommaso, P., Chatzou, M., Floden, E.W. et al. Nextflow enables reproducible computational workflows. *Nat Biotechnol* **35**, 316–319 (2017). [https://doi.org/10.1038/nbt.3820](https://doi.org/10.1038/nbt.3820)

And the respective citations for integration methods you use (see links above).
